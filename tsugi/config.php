...
$apphome = "http://localhost:8888/test-cloud/public";
...
$CFG->tool_folders = array("admin", "mod", "tsugi-php-samples");
...
$CFG->owneremail = 'csev@example.com';
...
// On a UNIX server, in order to run git from the a PHP script, we may need
// a setuid version of git - example commands if you are not root:
//
//    cd /home/csev
//    cp /usr/bin/git .
//    chmod a+s git
